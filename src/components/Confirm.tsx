        ...
        {opts && (
          <div className="space-y-5">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                onClick={() => close(true)}
                className={`px-4 py-2 rounded-lg text-sm font-medium text-white transition-colors ${opts.danger ? 'bg-red-600 hover:bg-red-700' : 'bg-slate-900 hover:bg-slate-800'}`}
              >
